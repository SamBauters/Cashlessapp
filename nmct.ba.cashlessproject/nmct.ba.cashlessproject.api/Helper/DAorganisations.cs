...
namespace nmct.ba.cashlessproject.api.Helper
{
    public class DAorganisations
    {
        ...
        public static bool CheckAccount(string username, string password)
        {
            ...
            string sql = "SELECT [Login] ,[Password] FROM [CashlessAdmin].[dbo].[Organisation] WHERE [Login] = @Login AND [Password] = @Password";
        ...
        public static void UpdateOrganisation(Organisations o, IEnumerable<Claim> claims)
        {
